(function() {
  ...
  Spine.List = (function(_super) {
    ...
    List.prototype.maybeSelectFirst = function() {
      if (!this.children('.active').length) return this.children(':first').click();
    };
    ...
    List.prototype.render = function(items) {
      ...
      if (this.selectFirst) return this.maybeSelectFirst();
    };
